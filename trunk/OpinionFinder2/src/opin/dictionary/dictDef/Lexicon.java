 ...
 *       &lt;sequence>
 *         &lt;element name="entry" type="{http://www.cs.pitt.edu/mpqa/}entryBaseType" maxOccurs="unbounded"/>
...
public class Lexicon {
    ...
    protected List<EntryBaseType> entry;
    @XmlElement(required = true)
     ...
     * 
     */
    public List<EntryBaseType> getEntry() {
        if (entry == null) {
            entry = new ArrayList<EntryBaseType>();
        }
        return this.entry;
    }
